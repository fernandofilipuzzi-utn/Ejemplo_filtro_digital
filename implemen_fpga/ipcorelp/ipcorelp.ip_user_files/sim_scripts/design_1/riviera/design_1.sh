...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/data/workspaces/workspace-facultad/electronica/electronica_IV/teoria_de_los_circuitos_II/cursos/2016/01_local/07_final/fpga/ipcorelp/ipcorelp.cache/compile_simlib/riviera"
  fi
