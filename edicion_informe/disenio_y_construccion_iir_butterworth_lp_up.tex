...
\textbf{Función de transferencia del filtro analógico}\newline
	\begin{tiny}
		\subfile{../design_matlab/output/stm32_iir_lp_butterworth_ecu_s.tex}
	\end{tiny}\newline
    	
    	\underline{Función de transferencia del filtro digital}\newline
	\begin{tiny}
		\subfile{../design_matlab/output/stm32_iir_lp_butterworth_ecu_z.tex}
	\end{tiny}\newline
...
\textbf{Respuesta en frecuencia}\newline
	...
	\begin{tabular}{p{0.5\textwidth} p{0.5\textwidth}}		
		\begin{wrapfigure}{l}{0.9\linewidth}
    		\centering
    		\includegraphics[width=\linewidth]{stm32_iir_lp_butterworth_2.jpg}
    		\caption{Filtro analógico}
		\end{wrapfigure}					
		&	
	 	\begin{wrapfigure}{l}{0.9\linewidth}
    		\centering
    		\includegraphics[width=\linewidth]{stm32_iir_lp_butterworth_6.jpg}
...
\textbf{Diagrama de Polos y ceros}
	...
	\begin{tabular}{p{0.5\textwidth} p{0.5\textwidth}}		
		\begin{wrapfigure}{l}{0.9\linewidth}
    		\centering
    		\includegraphics[width=\linewidth]{stm32_iir_lp_butterworth_1.jpg}
    		\caption{Filtro analógico}
		\end{wrapfigure}					
		&	
	 	\begin{wrapfigure}{l}{0.9\linewidth}
    		\centering
    		\includegraphics[width=\linewidth]{stm32_iir_lp_butterworth_5.jpg}
    		\caption{Filtro digital}
		\end{wrapfigure}		
	\end{tabular}\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline\newline
...
\lstinputlisting[language=c, frame=single]{../design_matlab/output/stm32_iir_lp_butterworth_stm32_coef.txt}
